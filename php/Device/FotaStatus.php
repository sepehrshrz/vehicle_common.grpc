...
/**
 * Generated from protobuf message <code>device.FotaStatus</code>
 */
class FotaStatus extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.device.FotaStatus.State state = 1;</code>
     */
    protected $state = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\SharedDFotaV1::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Device\FotaStatus\State::class);
        $this->state = $var;
